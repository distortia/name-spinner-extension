...
1. **Get the extension**
   ...
   - If you downloaded a ZIP, unzip it so you have a folder (e.g. `shopper-cx-extension` or `name-spinner`).

2. **Load it in Chrome**
   - Open **Chrome** and go to `chrome://extensions`.
   - Turn on **Developer mode** (toggle in the top-right corner).
   - Click **Load unpacked**.
   - In the file picker, select the extension folder (the one that contains `manifest.json`).
   - The extension should appear in your extensions list and its icon in the toolbar.

3. **Pin it (optional)**  
   - Click the puzzle piece in the toolbar and pin **Name Spinner** so you can open it with one click.
